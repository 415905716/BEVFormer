...
class TemporalSelfAttention(BaseModule):
    ...
    def __init__(self,
        ...
        self.sampling_offsets = Linear_Q(
            embed_dims*self.num_bev_queue, num_bev_queue*num_heads * num_levels * num_points * 2, weight_bit = self.weight_bit, activation_bit = self.activation_bit)
        self.attention_weights = Linear_Q(embed_dims*self.num_bev_queue,
                                           num_bev_queue*num_heads * num_levels * num_points, weight_bit = self.weight_bit, activation_bit = self.activation_bit)
