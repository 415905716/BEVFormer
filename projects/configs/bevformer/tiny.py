        ...
        transformer=dict(
            ...
            encoder=dict(
                ...
                transformerlayers=dict(
                    type='BEVFormerLayer',
                    attn_cfgs=[
                        dict(type='TemporalSelfAttention',), #quant_linear_Q
                        dict(type='SpatialCrossAttention', #quant_linear_Q
                            deformable_attention=dict(type='MSDeformableAttention3D', ),)])),#quant_linear_Q      
                ...
                transformerlayers=dict(type='DetrTransformerDecoderLayer',
                    attn_cfgs=[
                        dict(type='MultiheadAttention',),
                         dict(type='CustomMSDeformableAttention',), ],))),#quant_linear_Q
