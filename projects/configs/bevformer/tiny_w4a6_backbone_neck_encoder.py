...
quantize_encoder_bit=4
quantize_activation_bit=6
# checkpoint_t='/root/niko/BEVFormer/ckpts/bevformer_tiny_epoch_24.pth'
checkpoint_s='/root/niko/BEVFormer/work_dirs/tiny_w4a6_backbone_neck_from_ep23/epoch_11.pth'
model = dict(
    type='BEVFormer',
    use_grid_mask=True,
    ...
    img_backbone=dict(
        ...
        norm_eval=True,
        style='pytorch',
        conv_cfg=dict(type='Conv2d',weight_bit=quantize_backbone_bit, activation_bit=quantize_activation_bit, weight_percentile=0, act_percentile=0, full_precision_flag=False, quant_act=True),
    ...
    img_neck=dict(
        ...
        conv_cfg=dict(type='Conv2d', weight_bit=quantize_backbone_bit, activation_bit=quantize_activation_bit, full_precision_flag=False, quant_act=True)),
    pts_bbox_head=dict(
        type='BEVFormerHead', 
        bev_h=bev_h_,
        bev_w=bev_w_,
        weight_bit=quantize_encoder_bit,
        activation_bit=quantize_activation_bit,#quant_linear_Q
        num_query=900,
        num_classes=10,
        in_channels=_dim_,
